(function (root, factory) {
  ...
  const CASES = [
    { id: "unit1", num: "01", officialName: "观察简单组合体", caseName: "空间证物室", question: "被挡住的方块藏在哪里？", clue: "旋转证物，从三个方向核对轮廓。" },
    { id: "unit2", num: "02", officialName: "小数乘法", caseName: "小数点追踪", question: "积的小数点该落在哪里？", clue: "先按整数相乘，再追踪两个因数的小数位。" },
    { id: "unit3", num: "03", officialName: "小数除法", caseName: "除法迷雾", question: "怎样让除数先变成整数？", clue: "除数移动几位，被除数也必须移动几位。" },
    { id: "unit4", num: "04", officialName: "图形的运动", caseName: "轨迹重建", question: "图形究竟怎样到达新位置？", clue: "盯住对应点、旋转中心和移动方向。" },
    { id: "unit5", num: "05", officialName: "简易方程", caseName: "天平密码", question: "怎样操作还能保持两边平衡？", clue: "等式两边必须同时进行相同操作。" },
    { id: "unit6", num: "06", officialName: "可能性", caseName: "随机疑云", question: "哪种结果更容易发生？", clue: "先比较数量，再用多次实验核对判断。" },
    { id: "unit7", num: "07", officialName: "多边形的面积", caseName: "面积侦探", question: "陌生图形能变成熟悉图形吗？", clue: "剪、移、拼只改变形状，不改变面积。" },
    { id: "unit8", num: "08", officialName: "数学广角·植树问题", caseName: "间隔谜案", question: "棵数和间隔数差在哪里？", clue: "先判断两端，再数间隔。" },
    { id: "unit9", num: "09", officialName: "有趣的密铺", caseName: "密铺工坊", question: "这些图形为什么能铺满？", clue: "观察同一顶点周围的角能否正好拼成一周。" },
  ];
